...
* **Leakage-Free Architecture:** Implements a robust preprocessing pipeline where `MinMaxScaler` fits *only* on training data, preventing data leakage and ensuring realistic performance metrics.
